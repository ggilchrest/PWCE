...
export const gatewayProfile = deepFreeze({ profileId: PROFILE_ID, profileVersion: PROFILE_VERSION, bundleId: "pwce-agent-gateway.bundle.v1", bundleVersion: "1.0.0", schemaStatus: "published", schemaDigest: "3af96275bc26754a8cebc64febb10b5ca50c951fd5003f106e06cfda846d4d3b", operationCatalogVersion: "0.1.0", operationCatalogDigest: catalogDigest, compatibilityRange: { minimum: PROFILE_VERSION, maximum: "1.x" }, fixtures: [{ fixtureSetId: "pwce.shared.contract.vectors", fixtureSetVersion: "0.1.0", status: "published" }], health: { status: "development", custody: "bounded" }, operationCatalog });
