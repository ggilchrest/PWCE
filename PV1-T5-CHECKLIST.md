...
| Authenticated Lifestream client negotiates and queries the real local PWCE gateway | `pass` | `DEVELOPMENT-BATCH-160.md`; the current Lifestream client test passed against disposable PWCE gateway `http://127.0.0.1:4183` with both real Home Assistant sites synchronized |
